...
//     // Extract user IDs from members and createdBy fields
//     const userIds = new Set();
//     rows.forEach(row => {
//       if (Array.isArray(row.members)) {
//         row.members.forEach(id => userIds.add(id));
//       }
//       if (row.createdBy) {
...
//       db.sequelize.fn('JSON_CONTAINS', db.sequelize.col('collaborators'), JSON.stringify(userIdArray)),
//       true
//     );
...
//     const entitiesWithTaskCounts = await Promise.all(rows.map(async (entity) => {
//       const taskCounts = await getTaskCounts(userIdArray);
//       return {
//         ...entity.dataValues,
//         taskCounts,
//       };
