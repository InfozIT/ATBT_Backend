...
//     const userId = taskComments.map(item => parseInt(item.senderId));
//     // Removing duplicates from ids array
//     const uniqIds = [...new Set(userId)];
//     const users = await db.User.findAll({
//       attributes: ['image','name'], // Only fetch the entityId column
//       where: {
//         id: uniqIds // Filter users based on userIds array
//       },
//       raw: true // Get raw data instead of Sequelize model instances
//     });
//     console.log(users)
